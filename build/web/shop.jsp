...
<link href="css2/form.css" rel="stylesheet" type="text/css" media="all" />
 ...
 <!--   <div class="header-area">
   ...
   <div class="mainmenu-area" style="background-color: #0099CC;padding: 8px 8px 8px 8px;">
        <div class="container">
            <div class="row">
            ...
            <div class="row">-->
                <div class="col-md-12">
                    ...
                    <form method="GET" action="myresults">
                       ...
                       <h1> <span class="logo" style="padding-top: 0px;font-family: 'Open Sans';color:#fff;font-size: 25px"> SV E-Commerce</span></h1>
                            <input type="submit" value="Search" style="float:right;background-color:#66CCFF" onsubmit="myresults">
                            
                            <input type="text" class="" style="width:50%;float:right;" placeholder="Search products..." name="search">
                ...
                <div class="col-md-12" style="padding: 10px 10px 10px 10px;margin-left:auto ">
                   ...
                   <input class="checkbox-inline" type="checkbox" value="snapd" name="chk"  />
                     ...
                     <label><span style="font-weight: bold">&nbsp; Filter&nbsp;: </span></label>
                        <input type="text" name="from" class="form-control" placeholder="From.." style="width:auto"/>
                        <label><span style="font-weight: bold">&nbsp;to&nbsp;</span></label>
        ...
        %>
                 ...
                 <div class="col-md-3 col-sm-6">
                     <div class="single-product"  style="height: 350px;padding: 20px 20px 20px 20px">
                                        ...
                                        <div class="product-carousel-price" style="padding-bottom:  20%;font-size: 14px;height: 30%">
                                            <a href=" " style="font-weight: bold;font-size: 14px;"><%=ti%></a><br/><br/><span style="font-weight: bold"><b>Rating: <%= rat%> / 5</b> </span>
                                            <span class="myNum" style="float:right ;font-weight: bold"><b>Rs.<%= pri %></b></span>
...
%>
   ...
   <!-- <div class="footer-top-area">
       ...
       <div class="footer-bottom-area" style="float: bottom;margin-top: 6.5%;height: 80px;background-color: #5a88ca">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2016 SV E-Commerce. All Rights Reserved. <a href="#" style="color:white" target="_blank">SV E-Commerce.com</a></p>
                    </div>
                </div>
